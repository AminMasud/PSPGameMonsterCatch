...
cc -std=c99 -Wall -Wextra -Werror -fsanitize=address,undefined -Itests/host -Iinclude \
    ...
    src/npc.c src/npc_battle.c src/boss.c src/healing.c src/world_map.c src/progression.c src/gate.c src/dialogue.c src/encounter.c src/world_draw.c src/text.c \
